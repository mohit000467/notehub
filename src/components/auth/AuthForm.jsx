      ...
      <div className="w-full max-w-md">
        ...
        {forgotSent ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-500 mb-2">Password reset link sent to:</p>
              ...
              <div>
                <div className="relative">
                  ...
                  <input type="email" value={forgotEmail}
                    ...
                    className={`w-full bg-surface-elevated border rounded-xl pl-10 pr-4 py-3 text-sm text-white placeholder-gray-600 outline-none focus:border-ink-500 focus:ring-1 focus:ring-ink-500/30 transition-all ${forgotError ? "border-red-400/50" : "border-surface-border"}`} />
                </div>
                {forgotError && (
    ...
    <div className="w-full max-w-md">
      ...
      {isLockedOut && (
        <div className="mb-5 p-4 bg-red-500/10 border border-red-500/30 rounded-xl flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-red-400 mb-0.5">Account Temporarily Locked 🔒</p>
            <p className="text-xs text-red-300/70">Too many failed attempts. Try again in:</p>
            <p className="text-lg font-mono font-bold text-red-400 mt-1 flex items-center gap-1">
        ...
        <div>
          <div className="relative">
            ...
            <input name="email" type="email" value={formData.email} onChange={handleChange}
              ...
              className={`w-full bg-surface-elevated border rounded-xl pl-10 pr-4 py-3 text-sm text-white placeholder-gray-600 outline-none focus:border-ink-500 focus:ring-1 focus:ring-ink-500/30 transition-all disabled:opacity-50 ${errors.email ? "border-red-400/50" : "border-surface-border"}`} />
          </div>
        ...
        <div>
          <div className="relative">
            ...
            <input name="password" type={showPassword ? "text" : "password"} value={formData.password}
              ...
              disabled={isLockedOut}
              className={`w-full bg-surface-elevated border rounded-xl pl-10 pr-10 py-3 text-sm text-white placeholder-gray-600 outline-none focus:border-ink-500 focus:ring-1 focus:ring-ink-500/30 transition-all disabled:opacity-50 ${errors.password ? "border-red-400/50" : "border-surface-border"}`} />
