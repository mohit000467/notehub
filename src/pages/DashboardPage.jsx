// src/pages/DashboardPage.jsx — Glassmorphism Edition
...
const StatCard = ({ icon: Icon, label, value, color, glowColor }) => (
  <div
    className="card-lift rounded-2xl p-5 flex items-center gap-4 relative overflow-hidden"
    style={{
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 page-enter">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <button
          ...
          className="btn-primary btn-glow flex items-center gap-2 px-5 py-2.5 rounded-2xl font-semibold text-sm"
        >
      ...
      {/* ── Unique ID Card ── */}
      <div
        className="rounded-2xl px-5 py-4 mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative overflow-hidden"
        style={{
      ...
      >
        ...
        <div>
          ...
          <p className="text-xl font-mono font-bold" style={{ color: "rgba(108,138,255,0.95)" }}>
        ...
        <div className="flex gap-2">
          <button
            ...
            className="glass-btn flex items-center gap-2 px-4 py-2 rounded-xl text-sm"
          >
      ...
      {/* ── Search Section ── */}
      <div className="rounded-2xl p-5 mb-6" style={glassPanel}>
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          ...
          <form onSubmit={handleUserSearch} className="relative">
            ...
            <input
              ...
              className="glass-input w-full rounded-xl pl-9 pr-16 py-2.5 text-sm font-mono"
            />
            <button
              type="submit"
        ...
        {loading ? (
          ...
          <div className="glass-card text-center py-16 rounded-2xl">
            ...
            <button onClick={() => navigate("/upload")}
              className="btn-primary btn-glow px-5 py-2.5 rounded-xl text-sm font-semibold">
          ...
          <div className="rounded-2xl overflow-hidden" style={glassPanel}>
            {/* Table Header */}
            <div
              className="grid grid-cols-12 px-5 py-3 border-b text-xs font-mono font-semibold uppercase tracking-widest"
            ...
            {notes.map((note, idx) => {
              ...
              return (
                <div
                  ...
                  style={{
                    borderBottom: idx !== notes.length - 1 ? "1px solid rgba(108,138,255,0.06)" : "none",
                  }}
                ...
                >
                  <div className="col-span-5 flex items-center gap-3 min-w-0">
                    <span
                      className="text-xs font-mono font-bold px-2.5 py-0.5 rounded-lg flex-shrink-0"
          ...
          <div className="animate-slide-up glass-card rounded-3xl p-6 max-w-sm w-full">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="glass-btn flex-1 py-2.5 rounded-xl text-sm font-medium"
              >
                Cancel
              </button>
              <button
