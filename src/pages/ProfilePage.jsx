...
import {
  ...
  Download, Star, Calendar, CheckCheck, Tag,
} from "lucide-react";
...
const ProfilePage = () => {
  ...
  // Reset unit filter when subject changes
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 page-enter">
      ...
      <div className="bg-surface-card border border-surface-border rounded-2xl p-6 mb-6">
        <div className="flex flex-col sm:flex-row items-start gap-5">
          <div className="w-20 h-20 rounded-2xl flex items-center justify-center text-white text-3xl font-bold font-display flex-shrink-0"
