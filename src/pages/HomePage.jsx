...
import { BookOpen, Users, Sparkles, LogIn, ArrowRight } from "lucide-react";
          ...
          <div className="flex flex-wrap gap-2">
            {subjects.slice(0, 14).map((subject) => (
              <button key={subject.subject}
                ...
                style={{ background: "rgba(15,18,32,0.7)", border: "1px solid rgba(108,138,255,0.1)", color: "var(--text-secondary)", backdropFilter: "blur(12px)" }}
                onMouseEnter={e => { e.currentTarget.style.color = "white"; e.currentTarget.style.borderColor = "rgba(108,138,255,0.3)"; }}
                onMouseLeave={e => { e.currentTarget.style.color = "var(--text-secondary)"; e.currentTarget.style.borderColor = "rgba(108,138,255,0.1)"; }}>
